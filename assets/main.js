				...
				sections = {
					'pandithudu': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-44210164-19', { 'page_path': '/#pandithudu' });
								},
							],
						},
					},
					'anubandham': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-44210164-19', { 'page_path': '/#anubandham' });
								},
							],
						},
					},
					'kala': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-44210164-19', { 'page_path': '/#kala' });
								},
							],
						},
					},
					...
					'sampradinchu': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-44210164-19', { 'page_path': '/#sampradinchu' });
								},
							],
						},
					},
					'biodata': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-44210164-19', { 'page_path': '/#biodata' });
								},
							],
						},
					},
